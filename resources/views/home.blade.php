...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="post"  action="{{url('store-form')}}">
       {{ csrf_field() }}
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::user()->name }}   @if (session('status'))
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
       ...
       <div class="col-lg-8">
            <form method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label" name="name">Name</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label" password="password">Password</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="time" class="form-control" date="time" name ="time">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" style="height: 100px" name="messgae"></textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example">
                      <option selected name="options">Open this select menu</option>
